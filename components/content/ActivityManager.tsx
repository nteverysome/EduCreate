...
export default function ActivityManager({ userId, onActivitySelect, onCreateNew }: ActivityManagerProps) {
...
function ActivityCard({ activity, viewMode, isSelected, onSelect, onClick }: ActivityCardProps) {
