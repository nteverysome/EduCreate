...
// 可拖動的元素組件
function DraggableItem({ element, isSelected }: DraggableItemProps) {
...
export default function DragDropEditor({ elements, selectedElementId, onDragEnd }: DragDropEditorProps) {
