    ...
    >
      ...
      <div className="flex-shrink-0 flex items-center gap-0 pt-2">
        ...
        <button
          ...
          className="w-7 sm:w-8 h-11 flex items-center justify-center text-gray-400 hover:text-red-600 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
          title="刪除項目"
          type="button"
        >
