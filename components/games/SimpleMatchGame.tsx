...
// 主遊戲組件
const SimpleMatchGame: React.FC = () => {
  ...
  // 只在客戶端進行隨機排序，避免 hydration 錯誤
  const shuffledWords = isClient ? shuffleArray(pairs) : pairs;
  const shuffledDefinitions = isClient ? shuffleArray(pairs) : pairs;
...
export default SimpleMatchGame;
