import { fullScreen } from '/games/math-attack-game/utils/screen.js'
import { pointerOver, pointerUp } from '/games/math-attack-game/utils/buttons.js'
...
export default class Hub extends Phaser.Scene {
    ...
    preload() {
        // Images
        this.load.image('quit', '/games/math-attack-game/assets/images/quit.png')
        this.load.spritesheet('fullscreen', '/games/math-attack-game/assets/images/fullscreen.png', { frameWidth: 48, frameHeight: 48 })
        this.load.spritesheet('sound', '/games/math-attack-game/assets/images/sound.png', { frameWidth: 48, frameHeight: 48 })
        // Audio
        this.load.audio('pleasant-creek-loop', ['/games/math-attack-game/assets/audio/pleasant-creek-loop.mp3', '/games/math-attack-game/assets/audio/pleasant-creek-loop.ogg'])
        //---------------------------------------------------------------------->
    ...
    update(t, dt) {
        if (this.handlerScene.sceneRunning === 'title') {
            ...
            this.quitBtn.visible = false
        } else if (this.handlerScene.sceneRunning === 'credits') {
