import * as logic from '/games/math-attack-game/logic/countdown.math.logic.js'
...
function chooseSolution(solution) {
    if (this.gamePlay.data.solution === parseInt(solution)) {
        ...
        if (this.gamePlay.score > currentScore) {
            ...
            this.add.text(this.width / 2, (this.height / 2) + 90, 'New Max Score: ' + this.gamePlay.score, { fontFamily: 'Open Sans', fontSize: '25px' }).setOrigin(.5)
        }
        return false
    }
}
