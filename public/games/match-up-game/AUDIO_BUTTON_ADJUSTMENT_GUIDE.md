...
| 預設 | 3 個卡片 | 5 個卡片 | 7 個卡片 | 10 個卡片 | 20 個卡片 | 說明 |
|------|---------|---------|---------|---------|---------|------|
| tiny | 10% | 10% | 12% | 14% | 16% | 超小（當前） |
| small | 12% | 12% | 14% | 16% | 18% | 小 |
| medium | 14% | 14% | 16% | 18% | 18% | 中等 |
| large | 16% | 16% | 18% | 18% | 18% | 大 |
| xlarge | 18% | 18% | 18% | 18% | 18% | 超大 |
...
size: {
    percentageFor3Items: 0.10,   // ← 改 3 個卡片的大小（當前：10%）
    percentageFor5Items: 0.10,   // ← 改 5 個卡片的大小（當前：10%）
    percentageFor7Items: 0.12,   // ← 改 7 個卡片的大小（當前：12%）
    percentageFor10Items: 0.14,  // ← 改 10 個卡片的大小（當前：14%）
    percentageFor20Items: 0.16,  // ← 改 20 個卡片的大小（當前：16%）
}
```
